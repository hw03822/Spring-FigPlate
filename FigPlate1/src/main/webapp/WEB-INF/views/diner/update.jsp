...
<title><fmt:message key="UPDATE_DINER"/></title>
...
<div class="wrapper">
   <article class="main-padding">
        <div class="except-main">
         ...
         <h2 class="WritingPage_Title"><fmt:message key="UPDATE_DINER"/></h2>
         <form class="WritingPage_Form" action="<c:url value='/diner/update'/>" method="post" enctype="multipart/form-data">
         <table class="info">
         <tr>
         ...
         <tr>
            ...
            <td><input type="text" name="dinerWriter" id="dinerWriter" value="${sessionScope.name}" readonly>
         ...
         <tr>
            ...
            <td><textarea name="dinerContent" rows="10" cols="100">${diner.dinerContent}</textarea></td>
         </tr>
         <tr>
            <th><fmt:message key="FILE"/></th>
            <td class="WritingPage_Filebox">
               <input class="WritingPage_UploadName" value="${diner.fileName}" placeholder="${diner.fileName}">
               <label for="file">파일찾기</label>
               <input type="file" name="file" id="file">
               <input type="hidden" name="fileId" value="${diner.fileId}">
            </td>
         </tr>
         <tr>
            <th>&nbsp;</th>
            <td class="WritingPage_button" style="text-align: right;">
               <input type="hidden" name="dinerId" value="${diner.dinerId}">
